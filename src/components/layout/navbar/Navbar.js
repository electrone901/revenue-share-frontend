...
export const Navbar = withRouter(({ account, connectWallet, logout }) => {
      ...
      <div className="grow">
        <AppBar position="static">
          <Toolbar>
            ...
            <Link to="/" className="whiteLink">
              <Typography className="nav-title" variant="h6" noWrap>
                NFT Revenue
              </Typography>
            </Link>
            ...
            {/* <Button className="whiteLink" component={Link} to="/stake">
              Stake
            </Button> */}
